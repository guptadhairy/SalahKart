  ...
  return (
    <div className="flex flex-col lg:flex-row h-screen">
      ...
      <div className="w-full lg:w-1/2 bg-white flex flex-col justify-center items-center px-8 lg:px-20 py-10 lg:py-0">
        ...
        <div className="font-dm-sans text-2xl lg:text-[25px] mt-4 text-center">Welcome, Get Started!</div>
        <div className="font-dm-sans font-medium text-xl lg:text-[30px] mt-10 text-center">Create Account</div>
        ...
        <div className="flex flex-col items-center mt-5">
          <div className="font-dm-sans font-light text-gray-600">Already have an account?</div>
          <Link className="font-dm-sans font-medium text-blue-600 hover:underline" to="/login">
            Login
          </Link>
        </div>
      </div>
